...
# qmake project include file for including the qwt libraries
...
contains(QWT_CONFIG, QwtPlot) {
    ...
    HEADERS += \
        ...
        $$PWD/qwt_legend.h \
        $$PWD/qwt_legend_item.h \
        $$PWD/qwt_legend_itemmanager.h \
        $$PWD/qwt_plot.h \
